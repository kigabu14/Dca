...
def summarize_portfolio_with_gemini(portfolio_df: pd.DataFrame, model_name="gemini-1.5-flash"):
    ...
    try:
        ...
        prompt = (
        “คุณคือผู้ช่วยนักวิเคราะห์การลงทุน ทำหน้าที่วิเคราะห์พอร์ตหุ้นของผู้ใช้ โดยใช้ข้อมูลข่าวสารจากสื่อสังคมออนไลน์ “”(social media), ข่าวเศรษฐกิจ, ข่าวธุรกิจ, และข้อมูลพื้นฐาน/เทคนิคของหุ้นจริงเป้าหมายคือให้คำแนะนำที่แม่นยำตามสถานการณ์ปัจจุบัน ไม่มโน ไม่เดา“

        ”{portfolio_data} ตารางหุ้น, ราคาเฉลี่ย, ราคาปัจจุบัน, กำไร/ขาดทุน %, Dividend Yield“
        "{news_data}    สรุปข่าว, โพสต์ social, บทวิเคราะห์, ข้อมูลเทคนิค เช่น EMA, RSI, ATR”
        ...
        “รูปแบบการตอบ:-📈 **ควรถัวเพิ่ม:** [ชื่อหุ้น] - [เหตุผล],- ✋ **ถือรอดู:** [ชื่อหุ้น] - [เหตุผล],- 📉 **ควรขาย:** [ชื่อหุ้น] - [เหตุผล],- 🌱 **ตัวเลือกเติบโตใหม่:** [ชื่อหุ้น] - [เหตุผล]”
