...
def summarize_portfolio_with_gemini(portfolio_df: pd.DataFrame, model_name="gemini-1.5-flash"):
    ...
    try:
        ...
        prompt =    ( """
                    คุณคือผู้ช่วยนักวิเคราะห์การลงทุนแนว DCA ที่ทำงานตามข้อมูลจริงแบบมืออาชีพ 
                    ไม่มโน ไม่เดา ใช้เฉพาะข้อมูลที่ได้รับเท่านั้น 
                    ให้คำแนะนำที่สอดคล้องกับวินัยการลงทุนและความเสี่ยง
                    ...
                    จงวิเคราะห์และสรุปเป็นหมวดหมู่:
                    1) 📈 ควรถัวเพิ่ม: หุ้นใด เพราะอะไร 
                       - อธิบายเหตุผล เช่น ราคาอยู่ในโซนสะสม, เทรนด์ดี, ข่าวบวก, พื้นฐานยังแข็งแรง
                    2) ✋ ถือรอดู: หุ้นใด เพราะอะไร 
                       - อธิบายเหตุผล เช่น ข่าวไม่ชัดเจน, รอดูสัญญาณเทคนิค, รอดูผลประกอบการ
                    3) 📉 ควรขายตัดขาดทุน: หุ้นใด เพราะอะไร 
                       - อธิบายเหตุผล เช่น แนวโน้มธุรกิจถดถอย, ข่าวลบ, หลุดแนวรับสำคัญ
                    4) 🌱 ตัวเลือกเติบโตใหม่ (ถ้ามีจากข่าว) 
                       - ชื่อหุ้น + เหตุผลแบบสั้น ทำไมถึงน่าสนใจ
                    
                    ข้อกำหนด:
                    - ถ้าข้อมูลไม่เพียงพอให้ระบุว่า 'ไม่มีข้อมูลเพียงพอ'
                    - ห้ามรับรองผลตอบแทน
                    - ให้ bullet สั้น กระชับ ชัดเจน เป็นภาษาไทย
                    """ )
